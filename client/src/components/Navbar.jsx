...
const Navbar = ({ searchFilter, metamaskInstalled }) => {
  ...
  return (
    <div className="flex md:flex-row flex-col-reverse justify-between mb-[35px] gap-6">
      <div
        className={`${
          location.pathname === "/" ? "lg:flex-1" : "lg:w-full"
        } flex flex-row max-w-[458px] py-2 pl-4 pr-2 h-[52px] `}
      >
        {location.pathname === "/" ? (
          <div
          ...
          >
            <input
              ...
              type="text"
              placeholder="Search for charity by title"
      ...
      <div className="sm:hidden flex justify-between items-center relative">
        ...
        <div
          className={`absolute top-[60px] right-0 left-0 bg-[#EEF2F6] z-10 shadow-secondary py-4 ${
