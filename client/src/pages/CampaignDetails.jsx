    ...
    <div>
      ...
      <div className="w-full flex md:flex-row flex-col mt-10 gap-[30px]">
        <div className="flex-1 flex-col">
          ...
          />
          <div
            className={`relative w-full h-[5px] bg-[${palette.primaryLight}] mt-2`}
          >
            <div
              className={`absolute h-full bg-[${palette.primaryDark}]`}
              style={{
      ...
      <div className="mt-[60px] flex lg:flex-row flex-col gap-5">
        ...
        <div className="flex-1">
          ...
          <div
            className={`mt-[20px] flex flex-col p-4 bg-[${palette.primaryLight}] rounded-[10px]`}
          >
            ...
            <div className="mt-[30px]">
              ...
              <div
                className={`my-[20px] p-4 bg-[${palette.primaryDark}] rounded-[10px]`}
              >
              ...
              <CustomButton
                btnType="button"
                title="Fund Campaign"
                styles={`w-full bg-[${palette.primaryMain}]`}
